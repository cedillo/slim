	...
	<head>
		...
		<script type="text/javascript"> 
			...
			window.onload = function () {
				...
				var grAvances4, grAvances5, grAvances6, grAvances7, grAvances8, grAvances9, grAvances10, grAvances11, grAvances12;
				setGrafica(grAvances4, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica4" );
				setGrafica(grAvances5, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica5" );
				setGrafica(grAvances6, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica6" );
				setGrafica(grAvances7, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica7" );
				setGrafica(grAvances8, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica8" );
				setGrafica(grAvances9, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica9" );
				setGrafica(grAvances10, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica10" );
				setGrafica(grAvances11, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica11" );
				setGrafica(grAvances12, "dpsTipoAcopio", "pie", "Avances 3", "CanvasGrafica12" );	
			...
			function cambiarModo(sModo){
				...
				if (sModo=="M-REGIONES"){
					...
					stylesActual = [
					//{stylers: [{ hue: "#610B0B" },{ saturation: 250 }]},
					  {stylers: [{ hue: "#2c3e50" },{ saturation: 200 }]},
					  {featureType: "road",elementType: "geometry",stylers: [{ lightness: 50 },{ visibility: "simplified" }]},
					  {featureType: "road",elementType: "labels",stylers: [{ visibility: "off" }]}
					];		

					inicializar();		
					pintarAuditorias('ptsAuditoriasByArea', mapa);			
