...
<html lang="en"><head>
  ...
  var bBusquedaPorEmpleado = false;
	...
	function habilitarEmpleados(sTipo){
		...
		//alert("Valor de busquedaPorEmpleado: " + bBusquedaPorEmpleado);
		...
		if (bBusquedaPorEmpleado==true ){
			...
			if( document.all.operacion.value == 'INS') {
				...
				document.all.txtPaterno.readOnly=true;
				document.all.txtMaterno.readOnly=true;
				document.all.txtArea.readOnly=false;
										...
										<div class="modal-body">
											...
											<form id="formulario" METHOD='POST' action='/guardar/usuario_HVS' role="form">								
												...
												<div class="form-group">
													...
													<label class="col-xs-2 control-label" style="text-align:right">Nivel</label>
													<div class="col-xs-2">
												...
												<div class="form-group">
													...
													<label class="col-xs-4 control-label" style="text-align:right">Estatus</label>
													<div class="col-xs-2">
