 								...
 								<div class="form-group">									
									<div class="row">
										<div class="form-group">
											...
											<div class="col-xs-12" id="txtActividadEdit"><textarea class="form-control" readonly style="resize:none;" rows="3" id="idEstudio" name="txtEstudio"></textarea></div>
										</div>
									</div> 		
								</div>							
 								...
 								<div class="form-group">									
									<div class="row">
										<div class="form-group">
											...
											<div class="col-xs-12" id="txtActividadMuestra"><textarea class="form-control" readonly style="resize:none;" rows="3" id="idMuestra" name="txtMuestra"></textarea></div>
										</div>
									</div> 		
								</div>
 								...
 								<div class="form-group">									
									<div class="row">
										<div class="form-group">				
											...
											<div class="col-xs-12" id="txtActividadPruebas"><textarea class="form-control" readonly style="resize:none;" rows="3" id="idPruebas" name="txtPruebas"></textarea></div>
										</div>
									</div> 		
								</div>
 								...
 								<div class="form-group">									
									<div class="row">
										<div class="form-group">
											...
											<div class="col-xs-12" id="txtActividadProcedimiento"><textarea class="form-control" readonly style="resize:none;" rows="3" id="idProcedimiento" name="txtProcedimiento"></textarea></div>
										</div>
									</div> 		
								</div>
 								...
 								<div class="form-group">									
									<div class="row">
										<div class="form-group">	
											...
											<div class="col-xs-12" id="txtActividadObservacion"><textarea class="form-control" readonly style="resize:none;" rows="3" id="idObservacion" name="txtObservacion"></textarea></div>
										</div>
									</div> 		
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">									
				...
				<div class="modal-body">
						<div class="row">
							<div class="form-group">									
								<div class="col-xs-20"><textarea class="form-control" rows="20" disabled id="txtTextoAmplio2" name="txtTextoAmplio2" style=" height: 288px !important; width: 583px !important; resize:none;"></textarea></div>
							</div>
						</div>
					<div class="clearfix"></div>
				</div>				
