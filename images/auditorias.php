  ...
  <meta charset="utf-8">
  	...
  	<style type="text/css">		
		@media screen and (min-width: 768px) {
			...
			#modalLocalizacion .modal-dialog  {width:70%;}
		...
		//alert("Buscando Actividades: " + '/'+ lista + '/' + valor);
			...
			success: function(response) {
				...
				for (var i = 0; i < jsonData.datos.length; i++) {
					...
					renglon=document.createElement("TR");			
					renglon.innerHTML="<td>" + dato.numero + "</td><td>" + dato.tipo + "</td><td>" + dato.resul + "</td><td>" + dato.texto + "</td><td>" + dato.fecha + "</td><td>" + dato.estatus + "</td><td><a href='/papeles/"+ dato.anexo +"'>" + "<img src='img/xls.gif'>" + "</a></td>";

					

					//<td>" + dato.estatus + "</td><td>" + "<img src='img/xls.gif'> " + "</td>"
...
function limpiarCamposActividad(){
	...
	$( "#btnCancelarActividad" ).click(function() {
		...
		$( "#btnLocalizacion" ).click(function() {
			$('#modalLocalizacion').removeClass("invisible");
			$('#modalLocalizacion').modal('toggle');
					...
					<div class="widget">
						...
						<div class="widget-head">
						  ...
						  <div class="widget-icons pull-right"> 
							...
							<button type="button" id="btnLocalizacion"		class="btn btn-warning  btn-xs"><i class="fa fa-location"></i> Localización</button>
