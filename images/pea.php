					...
					<div class="widget">
						...
						<div class="widget-content">						
							...
							<div class="form-group">									
								...
								<div class="col-xs-3"><input type="text" id="FIRA" class="form-control" readonly onchange="validarfechaIRA(FIRA.value)" name="txtFIRA" onkeydown="return false;"/></div>


								<label class="col-xs-3 control-label"> Fecha IFA</label>
								<div class="col-xs-3"><input type="text" id="FIFA" class="form-control" readonly onchange="validarfechaIFA(FIFA.value)" name="txtFIFA" onkeydown="return false;" style="resize:none; margin: 0 0 6px 0 !important;"/></div>
							</div>
							<br>
							...
							<div class="col-xs-5">
								...
								<div class="form-group">
									<div style="margin: 17px 0px 0px ! important;" class="col-xs-12">
										<label class="col-xs-6 control-label">Objetivo(s) <i class="fa fa-pencil"  id="txtObjetivoEdit" readonly></i></label>
									</div>
								</div>
								<div class="form-group">
									<div class="col-xs-12"><textarea class="form-control" rows="3" placeholder="Objetivo(s)" id="txtObjetivo" name="txtObjetivo" readonly></textarea></div>
								</div>
							</div>		
						<br>
