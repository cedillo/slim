...
<div class="col-md-12">
				  <div class="widget">
					<div class="widget-head">
					  <div class="pull-left"><h3 class="pull-left"><i class="fa fa-home"></i> Catálogo de Procesos</h3></div>
					  <div class="widget-icons pull-right">
						<button onclick="agregarDocumento();" type="button" class="btn btn-primary  btn-xs">Nuevo Proceso...</button> 						
					  </div>  
								...
								<table class="table table-striped table-bordered table-hover">
								  ...
								  <tbody >									  
									<tr onclick=<?php echo "agregarDocumento();"; ?> style="width: 100%; font-size: xx-small">
										<td>P-0001</td><td>Nuevo</td><td>01/01/2016 al 31/12/2016</td><td>ACTIVO</td>
									</tr>
									<tr onclick=<?php echo "agregarDocumento();"; ?> style="width: 100%; font-size: xx-small">
										<td>P-0002</td><td>Nuevo</td><td>01/01/2016 al 31/12/2016</td><td>ACTIVO</td>
									</tr>
									<tr onclick=<?php echo "agregarDocumento();"; ?> style="width: 100%; font-size: xx-small">
										<td>P-0003</td><td>Nuevo</td><td>01/01/2016 al 31/12/2016</td><td>ACTIVO</td>
									</tr>																		
								  </tbody>
								</table>
							</div>
