...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">  
  ...
  <script type="text/javascript"> 
	...
	function activaDetalles(tmpSeccionActual){			
		...
		alert("Valor de tmpSeccionActual: " + tmpSeccionActual);
	...
	function validarCuenta(){
		...
		function checkfile(sender) {
			...
			function completeHandler(event){
				...
				//alert("Se cargó el archivo " + sArchivoCarga + " al Server de la cuenta: " + sCuentaActual + " TIPO DE CUENTA: " + tipoCarga );
				if(confirm("Se ha recuperado el archivo " + sArchivoCarga + "\n\n¿Deseas cargarlo en la base de datos?\n\nDar clic en ACEPTAR para iniciar proceso de carga, CANCELAR para salir...")==true){
					
					document.all.imgCargando.style="display:inline";
					document.all.btnsCarga.style.display='none';
					
					$.ajax({
						type: 'GET', url: '/cargarArchivo/' + tipoCarga + '/' + sArchivoCarga + '/' + sCuentaActual ,
						success: function(response) {							
			...
			function errorHandler(event){
				document.all.status.innerHTML = "Upload Failed";
			}
			
			function abortHandler(event){
				document.all.status.innerHTML = "Upload Aborted";
			}	
	...
	$(document).ready(function(){
		...
		recuperarLista('lstAniosCuentaPublica', document.all.txtAnio);
		
		document.getElementById('btnUpload').addEventListener('change', abrirArchivo, false);
	
		$( "#btnGuardar" ).click(function() {
			if (validarCuenta()){document.all.formulario.submit();}			
		});
						...
						<div class="table-responsive" style="height: 400px; overflow: auto; overflow-x:hidden;">
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody >									  
									...
									<tr onclick=<?php echo "javascript:recuperaCuenta('" . $valor['id'] . "');"; ?> style="width: 100%; font-size: xx-small">
									...
									<div class="tab-pane active" id="tab-generales">
										<div id="capturaDocto">
											...
											<div class="form-group">
												...
												<label class="col-xs-6 control-label" style="text-align:right">Año</label>
												<div class="col-xs-2">
											...
											<div class="form-group">
												...
												<div class="col-xs-10"><input type="text" class="form-control" name="txtNombre"/></div>													
											</div>												
											<br>
											<!--
											<div class="form-group">
												<label class="col-xs-2 control-label" style="text-align:right">Inicia</label>
												<div class="col-xs-4"><input type="date" class="form-control" name="txtFechaInicio" placeholder="Fecha Inicio" /></div>	
												<label class="col-xs-2 control-label" style="text-align:right">Termina</label>	
												<div class="col-xs-4"><input type="date" class="form-control" name="txtFechaFin" placeholder="Fecha de Término" /></div>												
											</div>
											-->
											<div class="form-group">
												<label class="col-xs-1 control-label" style="text-align:right">Inicia</label>
												<div class="col-xs-2">
													<input type="text" id="datepicker" class="form-control" name="txtFechaInicio" placeholder="Fecha Inicio"/>
												</div>
												<label class="col-xs-6 control-label" style="text-align:right">Termina</label>	
												<div class="col-xs-2">
											...
											<div class="form-group">
												<label class="col-xs-1 control-label" style="text-align:right">Notas</label>						<div class="col-xs-9">
					...
					<div id="btnsCarga">
						<div class="pull-left">					
							<form id="upload_form" enctype="multipart/form-data" method="post">								
									<button  type="button" class="btn btn-default" id="btnCargaEgreso" style="display:none;"><i class="fa fa-link"></i> Cargar Egreso...</button>
									<button  type="button" class="btn btn-default" id="btnCargaIngreso" style="display:none;"><i class="fa fa-link"></i> Cargar Ingreso...</button>									
									<input type="file" name="btnUpload" accept="application/pdf,application/vnd.ms-excel" style="display:none;" id="btnUpload" value="Cargar #1">
									<h3 id="status"></h3>									
							</form>
						</div>							
						...
						<button  type="button" class="btn btn-primary active" id="btnGuardar" 	style="display:inline;"><i class="fa fa-floppy-o"></i> Guardar Cuenta</button>	
