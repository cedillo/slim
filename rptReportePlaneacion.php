  ...
  <div class="col-md-8" style="padding:0px"> 
		...
		<?php
			...
			foreach($result as $row) {
				...
				echo "<tr><td width='25%'><b>DIRECCIÓN GENERAL: </b></td><td width='37%'></td><td width='13%'><b>CLAVE: </b></td><td>".$row['claveAuditoria'] . "</td></tr>";
				echo "<tr><td width='25%'><b>DIRECCIÓN GENERAL: </b></td><td width='37%'>".$row['sArea']."</td><td width='13%'><b>CLAVE: </b></td><td>".$row['claveAuditoria'] . "</td></tr>";
				echo "<tr><td width='25%'><b>DIRECCIÓN ÁREA: </b></td><td width='37%'>".$row['sResponsable']."</td><td width='13%'><b>RUBRO O FUNCIÓN DE GASTO: </b></td><td>".$row['sObjeto'] . "</td></tr>";
				echo "<tr><td width='25%'><b>SUJETO FISCALIZADO: </b></td><td width='37%'>".$row['sSujeto']."</td><td width='13%'><b>TIPO DE AUDITORÍA: </b></td><td>".$row['sTipo'] . "</td></tr>";
				//echo "<tr><td><b>DIRECCIÓN ÁREA</b><br>".$row['sResponsable'] . "</td><td><b>RUBRO O FUNCIÓN DE GASTO<br><p>".$row['sObjeto']."</p></td></tr>";
				...
				echo "<tr><td width='25%'><b>OBJETIVO DE LA AUDITORIA: </b></td><td colspan='12'>".$row['sObjetivo']."</td></tr>";
				echo "<tr><td width='25%'><b>ALCANCE DE LA AUDITORIA: </b></td><td colspan='12'>".$row['sObjetivo']."</td></tr>";
				//echo "<tr><td colspan=12><b>OBJETIVO</b><p>".$row['sObjetivo']."</p></td></tr>";
				//echo "<tr><td colspan=12><b>ALCANCE DE LA AUDITORIA: </b><p>".$row['sObjetivo']."</p></td></tr>";
				echo "</table>";
				...
				$nPagina=1;
				foreach($rs3 as $row3) {
					echo "<tr><td colspan=12><p align='left'><p><b>".$row3['nombre']."</b></p><p style='text-align: justify;'>".$row3['actividad']."</p></th></tr>";							
