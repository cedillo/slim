  			...
  			<div class="row" id="capturaAuditoria" style="display:none; padding:0px; margin:0px;">			
				<div class="col-xs-12">				
					<div class="widget">
						<!-- Widget head -->
						<div class="widget-head">
						  <div class="pull-left"><h3><i class="fa fa-pencil-square-o"> </i> Planeación Específica de Auditoria</h3></div>
						  <!--<div class="widget-icons pull-right">-->
						...
						<div class="widget-content">						
							...
							<div class="form-group">									
								...
								<div class="col-xs-2" style="width:1% !important;"><button type='button' id="modifa"  onclick="modificarfecha('moifa');"><i class='fa fa-pencil-square-o'></i></button></div>
							</div>
							<br>
							...
							<div class="col-xs-5">
								...
								<div class="col-xs-12">	
										<br>
										<table class="table table-striped table-bordered table-hover table-condensed">
											<caption>Personal Comisionado</caption>
											<thead>
											<tr style="font-size: xx-small"><th>Lider</th><th>Nombre</th><th>Puesto</th></tr>
											</thead>
									...
									<div class="tab-content">
										<div class="tab-pane" id="tab-documentos">
											<div class="table-responsive" style="height: 150px; overflow: auto; overflow-x:hidden;">
												<table class="table table-striped table-bordered table-hover">
												  <thead>
													<tr style="font-size: xx-small"><th>Docto.</th><th>Flujo</th><th>Tipo</th><th>Fecha</th><th>Prioridad</th><th>Impacto</th><th>Archivo</th></tr>
												  </thead>
										...
										<div class="tab-pane active" id="tab-papeles">
											<div class="table-responsive" style=" width: 100%; height: 150px; overflow: auto; overflow-x:auto; font-size: xx-small">
												<table class="table table-striped table-bordered table-hover">
												  <thead>
													<tr style="font-size: xx-small"><th>Clave Auditoria</th><th>ID Papel</th><th>Tipo Papel</th><th>Fase</th><th>Fecha Papel</th><th>Tipo Resultado</th><th>Resultado</th><th>Estatus</th><th>Documento</th></tr>
										...
										<div class="tab-pane " id="tab-acciones">
											<div class="table-responsive" style="height: 150px; overflow: auto; overflow-x:hidden;">
												<table class="table table-striped table-bordered table-hover">
													<thead>
													<tr style="font-size: xx-small"><th>No.</th><th>Tipo de Acción</th><th>Cédula de Potenciales</th><th>Dictámen Técnico</th><th>Estatus</th></tr>
													</thead>
													<tbody id="tablaAcciones" style="width: 100%; font-size: xx-small">										  
								...
								<div class="table-responsive" style=" width: 100%; height: 150px; overflow: auto; overflow-x:auto; font-size: xx-small">
									<table class="table table-striped table-bordered table-hover">
									  <thead>
										<tr style="font-size: xx-small"><th>Clave Auditoria</th><th>Sujeto de Fiscalización</th><th>Tipo de Auditoría</th><th>ID</th><th>Fase</th><th>Actividad</th><th>Porcentaje</th></tr>
									  </thead>
									  <tbody id="tablaAvances" style="width: 100%; font-size: xx-small">										  
		...
		<div class="modal-dialog">							
			...
			<div class="modal-content">									
				...
				<div class="modal-body" style="overflow: auto; overflow-x:hidden;">
					...
					<br>
					<div class="form-group">
						<label class="col-xs-2 control-label"> Fecha Confronta</label>
						<div class="col-xs-2"><input type="text" id="FConfronta" class="form-control"  readonly onchange="validarfechaConfronta(FConfronta.value,FIRA.value,FIFA.value);" name="txtFConfronta" onkeydown="return false;" style="resize:none; margin: 0 0 6px 0 !important;"/></div>
						<div class="col-xs-1" style="width:1% !important;"><button type='button' id="modconfro" style="display: none;" onclick='modificarfeconfro();'><i class='fa fa-pencil-square-o'></i></button></div>
						
						<label class="col-xs-2 control-label"> Fecha de IRAC</label>
						<div class="col-xs-2"><input type="text" id="FNotifica" class="form-control" readonly name="txtFNotifica" onkeydown="return false;" style="resize:none; margin: 0 0 6px 0 !important;"/>
						</div>

						<label class="col-xs-2 control-label" style="width: 14.3% !important;"> Fecha de IFA</label>
						<div class="col-xs-2"><input type="text" id="FIfa" class="form-control" readonly name="txtFIfa" onkeydown="return false;" style="resize:none; margin: 0 0 6px 0 !important;"/>
						</div>
