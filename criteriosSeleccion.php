           ...
           success: function(response) {
               ...
               for (var i = 0; i < jsonData.datos.length; i++) {
					...
					renglon.innerHTML="<td onclick='recuperaCriterioUnidad("+criUnidad+","+criAuxiliar+",\""+cuenta+"\",\""+cveUnidad+"\",\""+nomUnidad+"\");' style='width:10% !important;'>" + dato.cveUnidad + "</td><td onclick='recuperaCriterioUnidad("+criUnidad+","+criAuxiliar+",\""+cuenta+"\",\""+cveUnidad+"\",\""+nomUnidad+"\");' style='width:60% !important;'>" + dato.nombre + "</td>";
	                    ...
	                    //renglon.innerHTML='<td width="10%" >' + dato.cveUnidad + '</td><td width="60%" >' + dato.nombre + "</td>";
							...
							<div class="widget">
								...
								<div class="widget-content">												
									...
									<div class="col-xs-7">															
										...
										<div class="form-group">									
											<label class="col-xs-3 control-label">Tipo del Criterio</label>
											<div class="col-xs-5">
												<select class="form-control" name="txtTipoCriterio" id="txtTipoCriterio" >
									...
									<div class="col-xs-5">							
										<div class="form-group">
											<div class="table-responsive" style="height: 175px; overflow: auto; overflow-x:hidden; " id="divListaEntidades">
												<table class="table table-striped table-bordered table-hover table-condensed table-responsive" >
													<caption>Unidades Relacionadas</caption>
													<thead>
														<tr><th>Clave de Unidad</th><th>Nombre de Unidad</th></tr>
													</thead>
													<tbody id="tblListaEntidades" style="width: 150%; font-size: xx-small">
													</tbody>
												</table >
											</div>
											<br>
